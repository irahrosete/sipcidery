...
ActiveRecord::Schema.define(version: 2021_03_18_012252) do
  ...
  create_table "drink_retailers", force: :cascade do |t|
    t.bigint "drink_id", null: false
    t.bigint "retailer_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["drink_id"], name: "index_drink_retailers_on_drink_id"
    t.index ["retailer_id"], name: "index_drink_retailers_on_retailer_id"
  end
  ...
  add_foreign_key "drink_retailers", "drinks"
  add_foreign_key "drink_retailers", "retailers"
